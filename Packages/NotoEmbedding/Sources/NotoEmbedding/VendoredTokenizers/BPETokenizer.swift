//
//  Vendored from https://github.com/huggingface/swift-transformers (Sources/Tokenizers/BPETokenizer.swift)
//  Tag: 1.3.3, commit 2fa33e1f5e7131a7fc64c28e6d161dcec0d24820. License: Apache-2.0.
//  See VendoredTokenizers/LICENSE-NOTICE.md.
//  Local modifications: removed `import Hub`; added `ignore_merges` support (HF BPE checks the whole pre-tokenized token against the vocab before applying merges).
//
//
//  BPETokenizer.swift
//  CoreMLBert
...
class BPETokenizer: PreTrainedTokenizerModel, @unchecked Sendable {
    ...
    /// Whether to check if the whole pre-tokenized token is already in the vocabulary
    /// before applying BPE merges (`model.ignore_merges` in tokenizer.json).
    /// Matches https://github.com/huggingface/tokenizers BPE behavior.
