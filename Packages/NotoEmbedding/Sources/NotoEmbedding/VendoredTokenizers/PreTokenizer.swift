//
//  Vendored from https://github.com/huggingface/swift-transformers (Sources/Tokenizers/PreTokenizer.swift)
//  Tag: 1.3.3, commit 2fa33e1f5e7131a7fc64c28e6d161dcec0d24820. License: Apache-2.0.
//  See VendoredTokenizers/LICENSE-NOTICE.md.
//  Local modifications: removed `import Hub` (local Config shim lives in this module).
//
//
//  PreTokenizer.swift
//
