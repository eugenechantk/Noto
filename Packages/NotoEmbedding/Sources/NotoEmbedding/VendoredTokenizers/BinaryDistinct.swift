//
//  Vendored from https://github.com/huggingface/swift-transformers (Sources/Hub/BinaryDistinct.swift)
//  Tag: 1.3.3, commit 2fa33e1f5e7131a7fc64c28e6d161dcec0d24820. License: Apache-2.0.
//  See VendoredTokenizers/LICENSE-NOTICE.md.
//  Local modifications: BinaryDistinctString.init(NSString) builds the UTF-16 array directly from String.utf16 (same result, avoids per-Character flatMap; large-vocab load perf).
//
//
...
public struct BinaryDistinctString: Equatable, Hashable, Sendable, Comparable, CustomStringConvertible, ExpressibleByStringLiteral {
    ...
    public init(_ str: NSString) {
        value = Array((str as String).utf16)
    }
